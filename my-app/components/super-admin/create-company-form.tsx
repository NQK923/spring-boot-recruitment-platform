  ...
  return (
    <form className="space-y-4 text-sm" action={formAction}>
      <div className="space-y-2">
        ...
        <Input id="company-name" name="name" placeholder="Acme Labs" required />
      </div>
      <div className="space-y-2">
        <label htmlFor="company-website" className="font-semibold text-foreground">
          Website
        </label>
        <Input id="company-website" name="website" placeholder="https://example.com" />
      </div>
      <div className="space-y-2">
        ...
        <textarea
          ...
          name="description"
          placeholder="Short summary for recruiters..."
      ...
      <div className="space-y-2">
        ...
        <Input id="company-logo" name="logoUrl" placeholder="https://cdn.example.com/logo.png" />
      </div>
      {state?.error ? (
