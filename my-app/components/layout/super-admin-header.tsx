...
const superAdminNavigation: NavItem[] = [
  { href: `${ROUTES.superAdminDashboard}#overview`, label: "Overview" },
  { href: `${ROUTES.superAdminDashboard}#operations`, label: "Operations" },
  { href: `${ROUTES.superAdminDashboard}#companies`, label: "Companies" },
  { href: `${ROUTES.superAdminDashboard}#jobs`, label: "Jobs" },
  { href: `${ROUTES.superAdminDashboard}#accounts`, label: "Accounts" },
  { href: `${ROUTES.superAdminDashboard}#invitations`, label: "Invitations" },
];
